...
- [ ] **Phase 1: Account Config Foundation** - Build `src/accounts.ts` with types, loader, and resolver — everything else depends on this
...
|-------|----------------|--------|-----------|
| 1. Account Config Foundation | 1/2 | In Progress|  |
